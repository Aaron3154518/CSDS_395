...
def main():
    ...
    for index, row in search_song.iterrows():
        ...
        df['artist_indicator'] = np.where(df['artist_name']==row_df['artist_name'].to_numpy()[0],0.5,0)
        #...
        temp_arr.append(row_df)

    #Drop popularity in general maybe
    ...
    #CHANGE THIS TO GET EXACTLY THE OUTPUT YOU WANT...
